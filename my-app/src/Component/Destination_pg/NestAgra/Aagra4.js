...
import AOS from "aos";
import '../../Destination_pg/NestAgra/Aagra4.css'
import { Link } from 'react-router-dom';

function Aagra4({One,One1,Two,Two1,Three,Three1}) {
    ...
    return (
        <div>
            <div className="container mt-5" id='Aagra4'>
                <div className="row">
                    <h5 data-aos="zoom-in"> Activities To Do </h5>
