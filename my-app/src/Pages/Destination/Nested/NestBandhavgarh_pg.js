...
import On2 from '../../../Component/Asset/Destination/ban1.jpeg'
...
import On6 from '../../../Component/Asset/Destination/ban10.jpg'
import On7 from '../../../Component/Asset/Destination/ban8.jpg'
import On8 from '../../../Component/Asset/Destination/ban9.jpg'
function NestBandhavgarg_pg(props) {
  ...
  return (
    <div>
      <Jumbotron_1 heading=' Prime Tiger territory :- Bandhavgarh-national-park '></Jumbotron_1>
      <Aagra0 destination='Bandhavgarh-national-park' ></Aagra0>
...

      {
        go ?
          <>
            ...
            <Aagra01 One='Bandhavgarh-national-park' Two={On} Two1={On1} Three='Taj Swarna' Three1='Taj Swarna & Convention Centre, Bandhavgarh' Four='10,000' Four1='12,000'></Aagra01>
            <Footer></Footer>
          </>
          ...
          <>
            ...
            <Agra1 One=' About Bandhavgarh-national-park' Two='Wedged deep in the heart of India, Bandhavgarh National Park is prime tiger territory, with a reputation that precedes it. The striped cat is the star resident of these forests, which famously gave the world the white tiger. That apart it is also an exceptionally beautiful space that is steeped in history.' Three={On2}></Agra1>

            <Aagra2 One={On3} One1='Bandhavgarh National Park' Two={On4} Two1="Beyond the tiger" Three={On5} Three1='Local interactions'></Aagra2>

            <Aagra4 One={On9} One1='Keep your eyes peeled' Two={On10} Two1='Ride an elephant' Three={On11} Three1='Set your own trail'></Aagra4>

            <Aagra3 One={On6} One1='Collect some curios' Two={On7} Two1='Bring home a handicraft' Three={On8} Three1='Pick up a painting'></Aagra3>
...
export default NestBandhavgarg_pg;