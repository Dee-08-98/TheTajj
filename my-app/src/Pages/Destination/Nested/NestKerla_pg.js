...
function NestKerla_pg(props) {
  ...
  return (
    <div>
      <Jumbotron_1 heading=' Cultural Capital :- Kerla '></Jumbotron_1>
      <Aagra0 destination='Kerla' ></Aagra0>
...

      {
        go ?
          <>
            ...
            <Aagra01 One='Kerla' Two={On} Two1={On1} Three='Jammu Swarna' Three1='Kerla Swarna & Convention Centre, Kerla' Four='10,000' Four1='12,000'></Aagra01>
            <Aagra01 One='' Two={On} Two1={On1} Three='Haven' Three1='Haven Place & Convention Centre, Kerla' Four='14,000' Four1='16,000'></Aagra01>
            <Footer></Footer>
          </>
          ...
          <>
            ...
            <Agra1 One=' About Kerla' Two='Cocooned by glassy lakes and lofty, forested mountains, Srinagar is brimming with culture and beauty. With its picture-postcard Mughal gardens, elegant houseboats and colourful history, it is no wonder that it is otherwise called ‘Paradise on Earth.' Three={On2}></Agra1>
